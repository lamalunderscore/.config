...
class RegressionPlotter:
    ...
    def plot(self, model:object) -> None:
        ...
        if num_coefficients == 1:
            ...
            print(self._data[0], self._data[1], self._target)
            fig = plt.figure()
            ...
            ax.scatter3D(self._data[0], self._data.iloc(:,0), self._target, color = "orange", label = "Prediction")
        plt.ylim(0,)
        plt.xlim(left = 0)
        plt.show()
    ...
    def plot_all(self, model:"MultiLinearRegression") -> None:
        ...
        for i in range(num_coefficients):
            ...
            plt.scatter(self._data[i], self._target, label = "Data")
            plt.ylabel("Data")
