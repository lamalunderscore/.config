...
class RegressionPlotter:
    def __init__(self, data: pd.DataFrame, target: pd.DataFrame) -> None:
        """
        This initialies data points for this instance to plot as a
        scatterplot in different functions.
    ...
    def plot(self, model: object) -> None:
        """
        This function plots a regression line or plane
        depending on its number of coefficients.
